...
void Motor::turnLeft() {
    ...
    servo2.writeMicroseconds(1410);  // forward right motor
}

// Turn right
void Motor::turnRight() {
    servo1.writeMicroseconds(1600);  // forward left motor
    servo2.writeMicroseconds(1505);  // Stop right motor
}

void Motor::turnBackLeft() {
    servo1.writeMicroseconds(1505);  // Stop left motor
    servo2.writeMicroseconds(1600);  // back right motor
}

// Turn right
void Motor::turnBackRight() {
    servo1.writeMicroseconds(1410);  // back left motor
    servo2.writeMicroseconds(1505);  // Stop right motor
}
